...
from mopidy_eboback import backend, storage, translator
...
class LocalLibraryProviderTest(unittest.TestCase):
    ...
    def tearDown(self):  # noqa: N802
        ...
        try:
            os.remove(path_to_data_dir("eboback/library.db"))
        except OSError:
            pass

    def test_add_noname_ascii(self):
        name = "Test.mp3"
        uri = translator.playlist_item_to_uri(
    ...
    @mock.patch("mopidy_eboback.schema.list_distinct")
